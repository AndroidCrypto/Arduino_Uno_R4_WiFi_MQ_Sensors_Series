...
//Declare Sensor
MQUnifiedsensor MQ5(Board, Voltage_Resolution, ADC_Bit_Resolution, pin, MQType);
...
*/
  ...
  /*****************************  MQ CAlibration ********************************************/
  Serial.println("** Values from  MQ-5  ****");
...
void loop() {
  ...
  MQ5.setA(177.65);
  MQ5.setB(-2.56); 
  ch4 = MQ5.readSensor();  // Sensor will read PPM concentration using the model, a and b values set previously or from the setup
